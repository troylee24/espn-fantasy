...
class EspnData:
    ...
    def get_team_data(self) -> Tuple[dict, dict, dict, dict]:
        return self.team_table.get_data()
    ...
    def create_tables(self) -> None:
        ...
        self.team_table = TeamTable(team_df, self.data_dir)

        for season_id, records in records_dict.items():
            records_df = pd.DataFrame(records)
            season_table = SeasonTable(season_id, records_df, self.cats, self.data_dir)
